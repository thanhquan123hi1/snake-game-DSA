...
public class TwoSnakeController implements KeyListener, ActionListener {

	private TwoPlayerSnake twoSnake; // Quản lý hai rắn
	private TwoSnakePanel tspn; // Giao diện vẽ
	private Timer timer; // Bộ hẹn giờ để cập nhật trò chơi
	private final int BASE_DELAY = 250; // Độ trễ ban đầu

	public TwoSnakeController(TwoPlayerSnake twoSnake, TwoSnakePanel tspn) {
